...
use imgui::{im_str, Window, Condition};
...
fn main() {
    ...
    let (mut imgui, mut imgui_sdl2, mut imgui_renderer) = window.create_imgui();
    ...
    let camera = new_world.add_components((1,
    ...
    'main: loop {
        ...
        if display_gui {
            imgui_sdl2
                .prepare_frame(imgui.io_mut(), window.sdl_window(),
